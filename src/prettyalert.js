...
function insertHtml(title, content, type, btn) {
	...
	var htmlStr = '<div id="paoverlay"><div id="pamodalcontainer">' + svg + '<h2>' + title + '</h2><p>' + content + '</p>'+btn+'</div></div>';
...
function insertCss(){
	...
	var cssStr="<style>#paoverlay{visibility:hidden;opacity:0;position:absolute;left:0;top:0;width:100%;height:100%;text-align:center;z-index:1000;transition:opacity 500ms;-webkit-transition:opacity 500ms;-moz-transition:opacity 500ms;-o-transition:opacity 500ms;background-color:rgba(192,192,192,.7);font-family:'Open Sans','Helvetica Neue',Helvetica,Arial,sans-serif}#paoverlay div{width:400px;height:250px;margin:100px auto;background-color:#fff;border-radius:3%;padding:15px;text-align:center;transition:height 400ms cubic-bezier(.1,-1.5,.1,2.5),width 400ms cubic-bezier(.1,-1.5,.1,2.5);-webkit-transition:height 400ms cubic-bezier(.1,-1.5,.1,2.5),width 400ms cubic-bezier(.1,-1.5,.1,2.5);-moz-transition:height 400ms cubic-bezier(.1,-1.5,.1,2.5),width 400ms cubic-bezier(.1,-1.5,.1,2.5);-o-transition:height 400ms cubic-bezier(.1,-1.5,.1,2.5),width 400ms cubic-bezier(.1,-1.5,.1,2.5)}#closeModal{max-width:70px;opacity:0;color:#fff;background-color:#0080FF;text-decoration:none;width:60px;padding:10px 0;margin:0 auto;display:block;border-radius:10%;-webkit-transition:opacity 400ms;-moz-transition:opacity 400ms;-ms-transition:opacity 400ms;-o-transition:opacity 400ms;transition:opacity 400ms}#pamodalcontainer h2{font-size:30px;font-weight:600;color:#575757;margin:0}#pamodalcontainer p{color:#797979;font-size:16px;font-weight:300}svg{height:150px;margin:0}svg #succes{stroke-dashoffset:170;stroke-dasharray:170;transition:stroke-dashoffset 600ms linear;-webkit-transition:stroke-dashoffset 600ms linear;-moz-transition:stroke-dashoffset 600ms linear;-o-transition:stroke-dashoffset 600ms linear}svg #error{opacity:0;transform-origin:center center;stroke-dashoffset:0;stroke-dasharray:0;transition:all 600ms ease-in-out;-webkit-transition:all 600ms ease-in-out;-moz-transition:all 600ms ease-in-out;-o-transition:all 600ms ease-in-out}svg #warning{opacity:0;transition:opacity 600ms ease-in-out;-webkit-transition:opacity transform 600ms ease-in-out;-moz-transition:opacity 600ms ease-in-out;-o-transition:opacity 600ms ease-in-out}</style>";
...
function openModal(type){
	el = document.getElementById("paoverlay");
	mod = document.getElementById("pamodalcontainer");
...
function closeModal(type){
	var el = document.getElementById("paoverlay");
	var  mod = document.getElementById("pamodalcontainer");
